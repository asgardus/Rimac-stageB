/************************ dSPACE target specific file *************************
   ...
   Include file .\Asgardus_Challenge_rti1401\Asgardus_Challenge_th.c :
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\Asgardus_Challenge_rti1401\Asgardus_Challenge_th.c is for ST).
# endif
