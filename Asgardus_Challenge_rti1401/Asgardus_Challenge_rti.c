/*********************** dSPACE target specific file *************************
   ...
   Include file Asgardus_Challenge_rti.c:
...
#define RTB_STRUCTURE_NAME             Asgardus_Challenge_B
#define RTP_STRUCTURE_NAME             Asgardus_Challenge_P
...
static void rti_mdl_initialize_io_boards(void)
{
  ...
  if (can_type1_msg_M1[CANTP1_M1_C1_TX_STD_0X0]->timestamp > 0.0) {
    Asgardus_Challenge_B.SFunction1_o1_f = 0;/* processed - flag */
    Asgardus_Challenge_B.SFunction1_o2_j = 0;/* timestamp */
    Asgardus_Challenge_B.SFunction1_o3_k0 = 0;/* deltatime */
    Asgardus_Challenge_B.SFunction1_o4_i = 0;/* delaytime */
  }
  ...
  if (can_type1_msg_M1[CANTP1_M1_C1_TX_STD_0X1]->timestamp > 0.0) {
    Asgardus_Challenge_B.SFunction1 = 0;/* delaytime */
  }
