/************************ dSPACE target specific file *************************
   ...
   Include file .\solution1_7009_CAN_rti1401\solution1_7009_CAN_th.c :

   Task Configuration file for model : solution1_7009_CAN

   RTI1401 7.9 (02-Nov-2017)/2.17
   19-Jun-2018 13:11:39
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\solution1_7009_CAN_rti1401\solution1_7009_CAN_th.c is for ST).
# endif
